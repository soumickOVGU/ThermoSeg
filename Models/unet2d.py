    ...
    def __init__(self, in_channels, out_channels, k_size=3, stride=1, padding=1, bias=True, is_complex=False):
        ...
        if is_complex:
            self.conv = cnn.Sequential(
                cnn.Conv2d(in_channels=in_channels, out_channels=out_channels, kernel_size=k_size,
                        stride=stride, padding=padding, bias=bias),
                cnn.BatchNorm2d(num_features=out_channels),
                cnn.CReLU(inplace=True),
                cnn.Conv2d(in_channels=out_channels, out_channels=out_channels, kernel_size=k_size,
                        stride=stride, padding=padding, bias=bias),
                cnn.BatchNorm2d(num_features=out_channels),
                cnn.CReLU(inplace=True)
            )
...
class U_Net(nn.Module):
    ...
    def __init__(self, in_ch=1, out_ch=1, is_complex=False, out_mode=0):
        ...
        self.Maxpool1 = cnn.MaxPool2d(kernel_size=2, stride=2) if is_complex else nn.MaxPool2d(kernel_size=2, stride=2)
        self.Maxpool2 = cnn.MaxPool2d(kernel_size=2, stride=2) if is_complex else nn.MaxPool2d(kernel_size=2, stride=2)
        self.Maxpool3 = cnn.MaxPool2d(kernel_size=2, stride=2) if is_complex else nn.MaxPool2d(kernel_size=2, stride=2)
        self.Maxpool4 = cnn.MaxPool2d(kernel_size=2, stride=2) if is_complex else nn.MaxPool2d(kernel_size=2, stride=2)
        ...
        self.Conv = cnn.Conv2d(filters[0], out_ch, kernel_size=1, stride=1, padding=0) if is_complex else nn.Conv2d(filters[0], out_ch, kernel_size=1, stride=1, padding=0)
